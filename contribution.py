...
354000.00
'''
X = int(input().strip())  # Salary of senior players
Y = int(input().strip())  # Salary of junior players
senior_players = 6 
junior_players = 5
senior_contribution = (0.50 * X) * senior_players
junior_contribution = (0.40 * Y) * junior_players
